...
class fc_eval:
     ...
     def evaluate(self, inp_file_correct, inp_file_pred, out_file_path, results_file):
        ...
        results_path = results_file + '.json'
...
if __name__ == '__main__':
   obj = fc_eval()
   inp_file_path1 = 'lcquad2_anstype_wikidata_test_gold.json'
   inp_file_path2 = 'task1_wikidata_test_pred.json'                            #lcquad2_dummy_predictions.json
   out_file_path = 'lcquad2_full_predictions_with_rr.json'                     #lcquad2_dummy_predictions_with_rr.json
   results_file = 'final_scores_'
